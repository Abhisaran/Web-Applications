...
<div class = "navbar-left">  
 ...
 <div id="wrapper">
    ...
    ?>
                    ...
                    <div class="panel-heading"><i class="fa fa-circle fa-2x"></i><h1 class="panel-title" style="text-align:center;font-size:19px;"><?php echo $m.", ".$usr;?></h1></div></div>
    ...
    <?php
        ...
        $count=mysqli_num_rows($result);
                ...
                <center>
                            <div class="col-sm-4 col-lg-6">
                        <div class="panel panel-title bg-red" style="height:90px; width:auto; color:white; padding:25px;background-color:blue;border-radius:5px;">
                ...
                <center>
                <div class="col-sm-4 col-lg-6">
                    <div class="panel panel-title bg-red"style="height:90px; color:white; padding:25px;background-color:maroon;border-radius:5px;">
        ...
        <div class="row">
                ...
                <div id="row">
                                <center><div class="panel panel-primary"><div class="panel-title">Entry maker is used to make events details entered into database !!!</div></div></center>
